...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'a0ce0f4c42mshdf6a9f9ee03fcd6p18bbb0jsn235b4f53d6fe',
...
// console.log(myPost.volumeShort);
// console.log(myPost.domainContext);
...
.then(data =>{
	...
	options: {
	  ...
	  aspectRatio: 1, // Allow the chart to resize properly
            maxBarThickness: 20,
	}
...
// // console.log(graphData[0]);
// // console.log(graphData[0].name);
// // console.log(graphData[0].volumeShort);
...
// 	console.log(graphData[i].volumeShort);
// }
